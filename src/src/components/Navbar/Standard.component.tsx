...
export function Standard(): JSX.Element {
	...
	return (
		<Disclosure defaultOpen={true} as="nav" className="fixed top-0 left-0 w-full z-10">
			<div className="mx-auto px-2">
				<div className="relative flex items-center justify-between h-16">
					<Navbar.Dropdown items={menu} position="top-left" name="menu">
						<Button.Icon aria-label="Menu">
							<Navbar.Icon icon="feather:menu" />
						</Button.Icon>
					</Navbar.Dropdown>
					<Navbar.Dropdown items={settings} position="top-right" name="settings">
